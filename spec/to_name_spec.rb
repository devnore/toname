...
describe ToName do
  ...
  context 'tv show episodes' do
    it 'should handle SnnEnn format' do
      check_to_name('/test/My-Tvshow.S12E01.avi',
        'My Tvshow S12E01', 'My Tvshow', nil, 12, 1)
      check_to_name('/test/My-Tvshow.S12 E01.avi',
        'My Tvshow S12 E01', 'My Tvshow', nil, 12, 1)
    end


    context 'It should handle shows with years in it.' do
      check_to_name('doctor.who.2005.s03e03.720p.bluray.x264-shortbrehd.mkv',
        'doctor who', nil, nil, 3, 3)
    end
    ...
    it 'should handle x format' do
      check_to_name('/test/My-Tvshow.1x3.avi',
        'My Tvshow 1x3', 'My Tvshow', nil, 1, 3)
      check_to_name('/test/My-Tvshow.01x03.avi',
        'My Tvshow 01x03', 'My Tvshow', nil, 1, 3)
      check_to_name('/test/My-Tvshow.01x03.extra.avi',
        'My Tvshow 01x03 extra', 'My Tvshow', nil, 1, 3)
    end
  ...
  it 'should remove number from movie name if there is more than one file for the same movie' do
    ...
    check_to_name('/test/xscr-invictus_part1[dupedb.com].avi',
      'xscr invictus part1[dupedb com]',
      'xscr invictus part1[dupedb com]')
    check_to_name('/test/CD1/xscr-invictus_part1[dupedb.com].avi',
      'xscr invictus part1[dupedb com]', 'xscr invictus')
    check_to_name('/test/CD1/xscr-invictus_Part1[dupedb.com].avi',
      'xscr invictus Part1[dupedb com]', 'xscr invictus')
    check_to_name('/test/CD1/xscr-invictus_part 1[dupedb.com].avi',
      'xscr invictus part 1[dupedb com]', 'xscr invictus')
    ...
    check_to_name('/test/Crazy.Heart.DVDSCREENER.XviD-MENTiON/CD1/m-crheart-a.avi',
      'Crazy Heart DVDSCREENER XviD MENTiON', 'Crazy Heart')


    check_to_name('/test/CD1/dmt-intheloop1.avi',
      'dmt intheloop1', 'dmt intheloop')
  ...
  it 'should use folder name if media name is shortened' do
    ...
    check_to_name('/test/In.The.Loop.DVDRip.XviD-DMT/CD1/dmt-intheloop1.avi',
      'In The Loop DVDRip XviD DMT', 'In The Loop')

    check_to_name('/test/Assassination.Of.A.High.School.President.2008.DVDRip.XviD-ViSiON/aoahsp-xvid-vision.avi',
      'Assassination Of A High School President 2008 DVDRip XviD ViSiON',
  ...
  it 'should handle crap before movie name' do
    check_to_name('[www.Torrentday.com].Hereafter.DVDRip.XviD-DEFACED.avi',
      'Hereafter DVDRip XviD DEFACED', 'Hereafter')
    check_to_name('[www.tnttorrent.info].Please.Give.2010.[DVDRip.XviD-miguel].[Ekipa TnT].torrent',
      'Please Give 2010 [DVDRip XviD miguel] [Ekipa TnT]', 'Please Give', 2010)
  end
